...
class Settings:
    def __init__(self):
        ...
        self.app_id = '1'
        self.user_id = '185446'
        self.token = 'eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6IjhjZGY2ZTQ1LWY3NmYtNDEwNy1hNzA0LWQ4MmNkNTg0Y2YyNyJ9.vElEtqdJ0tXdPelCZm-VoU8jxv3gGsW74nQ3S54YxVXVtqiDyQuL5zJ7_kruw1iZY2gEPdC6QtwCv4XLjuqPmQ'
        # 订单状态
        self.status = '1'
        # 金额
        self.total_fee = '300'
